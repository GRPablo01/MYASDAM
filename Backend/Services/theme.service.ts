...
export class ThemeService {
  ...
  setThemeColors(isDark: boolean): void {
    if (isDark) {
      // 🌙 DARK MODE
      this.Backgroundprincipal = '#1C1E2E';   // fond principal bleu nuit
      this.Backgroundcards    = '#2E3150';   // carte niveau 1
      this.Backgroundcards1     = '#4A4C6D';   // carte niveau 2
      this.Backgroundcards2     = '#35364a';   // carte niveau 2
      ...
      // ☀️ LIGHT MODE
      this.Backgroundprincipal = '#FFFEFE';   // fond principal
      this.Backgroundcards     = '#E3E3E3';   // carte 1
      this.Backgroundcards1    = '#c6c4c4';   // carte 2
      this.Backgroundcards2     = '#bbbbbb';   // carte niveau 2
